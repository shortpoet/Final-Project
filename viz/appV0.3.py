...
def cocktails():
    ...
    if request.method == 'GET':
        ...
        for cock in cocktails:
            if cock['Cocktail_ID_Cocktails'] == 3:
                print(f"157{cock['Cocktail_ID_Cocktails']}")
        for gi in garnish_instructions:
            if gi['Cocktail_ID_Garnish_Instructions'] == 3:
